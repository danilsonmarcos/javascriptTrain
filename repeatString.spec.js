...
describe('repeatString', () => {
  test('repeats the string', () => {
    expect(repeatString('hey', 3)).equal('heyheyhey');
  });
  it.skip('repeats the string many times', () => {
    expect(repeatString('hello', 10)).equal('hellohellohellohellohellohellohellohellohellohello');
  });
  it.skip('repeats the string 1 time', () => {
    expect(repeatString('hi', 1)).equal('hi');
  });
  it.skip('repeats the string 0 times', () => {
    expect(repeatString('bye', 0)).equal('');
  });
  it.skip('does not use the built-in String repeat method', () => {
  ...
  it.skip('returns ERROR with negative numbers', () => {
    expect(repeatString('goodbye', -1)).toEqual('ERROR');
  });
  it.skip('repeats the string a random amount of times', function () {
  ...
  it.skip('works with blank strings', () => {
